...
export function AddStudentDialog() {
  ...
  const initialFormData = {
    ...
    department: '',      // text column synced from dept name
    madrasa_grade: '',   // synced from dept name
    usthadh_name: '',
  ...
  // Selecting a department auto-syncs department text + madrasa_grade
          ...
          <form onSubmit={handleCsvUpload} className="p-6 space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm">
              ...
              <ul className="list-disc list-inside text-blue-800 space-y-1">
                ...
                <li>madrasa_grade: Auto-synced from department name</li>
        ...
        /* ── SINGLE ENTRY FORM ── */
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-3">
              ...
              {/* Department — the single source of truth */}
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Department (Madrasa Class) *
                </label>
                <select
                ...
                {formData.madrasa_grade && (
                  <p className="text-xs text-gray-500 mt-1">
                    Madrasa Grade → <span className="font-medium text-gray-700">{formData.madrasa_grade}</span>
                  </p>
                )}
              </div>
